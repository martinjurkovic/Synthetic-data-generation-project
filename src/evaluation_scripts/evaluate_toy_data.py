...
nbins = 20
plt.hist(dcr, label='good', range=(0, 2.5), bins=nbins)
plt.hist(dcr_bad, label='bad', alpha=0.5, range=(0, 2.5), bins=nbins)
plt.hist(dcr_same, label='same', alpha=0.5, range=(0, 2.5), bins=nbins)
plt.hist(dcr_copied, label='copied', alpha=0.5, range=(0, 2.5), bins=nbins)
plt.title('Distance to closest record')
plt.legend()
plt.show()
...
plt.title('Nearest neighbour distance ratio')
plt.legend()
plt.show()
