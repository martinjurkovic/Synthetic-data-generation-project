...
# srun singularity exec --nv /d/hpc/projects/FRI/mj5835/containers/container-pytorch-2.0.0.sif python \
#     "NLP/nlp-course-mbj/T5_slovene_finetuning.py"

source /d/hpc/projects/FRI/mj5835/miniconda3/etc/profile.d/conda.sh # intialize conda
conda activate realtabformer_3_10 # activate the previously created environment
srun --nodes=1 --exclusive --gres=gpu:2 --ntasks=1 python /d/hpc/projects/FRI/mj5835/Synthetic-data-generation-project/src/generation_scripts/generate_rossmann_realtabformer.py