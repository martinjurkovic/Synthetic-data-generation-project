...
original_data['coupon_area_train'] = utils.add_primary_key(original_data['coupon_area_train'], 'coupon_area_train_id')
original_data['coupon_detail_train'] = utils.add_primary_key(original_data['coupon_detail_train'], 'coupon_detail_id')
original_data['coupon_visit_train'] = utils.add_primary_key(original_data['coupon_visit_train'], 'coupon_visit_train_id')
