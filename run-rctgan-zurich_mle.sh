#!/bin/bash
#SBATCH --job-name=RCT_ZUR_MLE
#SBATCH --output=logs/sling-rctgan-zurich_mle-%J.out
#SBATCH --error=logs/sling-rctgan-zurich_mle-%J.err
...
srun --nodes=1 --exclusive --gres=gpu:2 --ntasks=1 python /d/hpc/projects/FRI/mj5835/Synthetic-data-generation-project/src/generation_scripts/generate_rctgan.py --dataset-name zurich_mle