...
#SBATCH --output=logs/sling-sdv-zurich-mle-%J.out
#SBATCH --error=logs/sling-sdv-zurich-mle-%J.err
...
srun --nodes=1 --exclusive --ntasks=1 python /d/hpc/projects/FRI/mj5835/Synthetic-data-generation-project/src/generation_scripts/generate_sdv.py --dataset-name zurich_mle 